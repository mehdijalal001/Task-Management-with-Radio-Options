...
@Component({
  selector: 'app-taskscategorystartenddate',
  templateUrl: './taskscategorystartenddate.component.html',
  styleUrls: ['./taskscategorystartenddate.component.scss']
})
export class TaskscategorystartenddateComponent implements OnInit {
  ...
  ngOnInit(): void {
        ...
        this._activatedRoute.paramMap.subscribe(params => {
          ...
          if (categoryID) {
            // this.id = TaskID;
            this.refreshDataWithCategoryIdStartdateEnddate(categoryID,startdate,enddate);
          }
        });
  }
